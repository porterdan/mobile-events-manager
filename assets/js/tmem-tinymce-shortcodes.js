 ...
 * JS for shortcodes
 *
 * @tmem-tinymce-shortcodes File name.
 * @package TMEM
 */
		...
		function (editor, url) {
			editor.addButton(
				'tmem_shortcodes_btn',
				{
					...
					icon: false,
					type: 'menubutton',
					tooltip: 'Insert TMEM shortcodes into your document',
					menu: [{
						text: 'Content Tags',
						menu:[{
							text: 'Application',
						...
						menu: [{
							text: 'Addons List',
							onclick: function() {
								editor.insertContent( '[tmem-addons filter_by="false" filter_value="false" list="p" desc="false" cost="true" addon_class="false" desc_class="false" cost_class="false"]' );
							}
						}, {
							text: 'Availability Checker',
							onclick: function() {
								editor.insertContent( '[tmem-availability label="Select Date" label_wrap="false" label_class="false" field_wrap="false" field_class="false" submit_text="Check Date" submit_wrap="true" submit_class="false" please_wait_text="Please Wait..." please_wait_class="false"]' );
							}
						}]
					}, {
						...
						menu: [{
							...
							onclick: function () {
								editor.insertContent( '[tmem-home]' );
							}
						}, {
							text: 'Client Contract',
							onclick: function () {
								editor.insertContent( '[tmem-contract]' );
							}
						}, {
							text: 'Client Payments',
							onclick: function () {
								editor.insertContent( '[tmem-payments]' );
							}
						}, {
							text: 'Client Playlist',
							onclick: function () {
								editor.insertContent( '[tmem-playlist]' );
							}
						}, {
							text: 'Client Profile',
							onclick: function () {
								editor.insertContent( '[tmem-profile]' );
							}
						}]
					}]
				}
