 ...
 * JS for shortcodes
 *
 * @mem-tinymce-shortcodes File name.
 * @package MEM
 */
		...
		function (editor, url) {
			editor.addButton(
				'mem_shortcodes_btn',
				{
					...
					icon: false,
					type: 'menubutton',
					tooltip: 'Insert MEM shortcodes into your document',
					menu: [{
						text: 'Content Tags',
						menu:[{
							text: 'Application',
						...
						menu: [{
							text: 'Addons List',
							onclick: function() {
								editor.insertContent( '[mem-addons filter_by="false" filter_value="false" list="p" desc="false" cost="true" addon_class="false" desc_class="false" cost_class="false"]' );
							}
						}, {
							text: 'Availability Checker',
							onclick: function() {
								editor.insertContent( '[mem-availability label="Select Date" label_wrap="false" label_class="false" field_wrap="false" field_class="false" submit_text="Check Date" submit_wrap="true" submit_class="false" please_wait_text="Please Wait..." please_wait_class="false"]' );
							}
						}]
					}, {
						...
						menu: [{
							...
							onclick: function () {
								editor.insertContent( '[mem-home]' );
							}
						}, {
							text: 'Client Contract',
							onclick: function () {
								editor.insertContent( '[mem-contract]' );
							}
						}, {
							text: 'Client Payments',
							onclick: function () {
								editor.insertContent( '[mem-payments]' );
							}
						}, {
							text: 'Client Playlist',
							onclick: function () {
								editor.insertContent( '[mem-playlist]' );
							}
						}, {
							text: 'Client Profile',
							onclick: function () {
								editor.insertContent( '[mem-profile]' );
							}
						}]
					}]
				}
