...
module.exports = function( grunt ) {
	...
	var pluginConfig = {
		...
		cssmin:	{
			build:	{
				files: {
					'<%= dirs.main.css %>/mem-admin.min.css': ['<%= dirs.main.css %>/mem-admin.css'],
					'<%= dirs.templates.css %>/mem.min.css': ['<%= dirs.templates.css %>/mem.css']
				}
			}
		},
		...
		uglify: {
			dist: {
				files: {
					...
					'<%= dirs.main.js %>/mem-ajax.min.js': ['<%= dirs.main.js %>/mem-ajax.js']
				}
			}
		},
