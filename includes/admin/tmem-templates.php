...
*/
	...
	*/
	...
	$email_dj_booking_confirm = '<h1>Booking Confirmation</h1>
								...
								<br />
								Make sure you login regularly to the <a href="{ADMIN_URL}admin.php?page=tmem-dashboard">{COMPANY_NAME} {APPLICATION_NAME} admin interface</a> to ensure you have all relevant information relating to their booking.<br />
								<br />
								Retmember it is your responsibility to remain in regular contact with your client regarding their event as well as answer any queries or concerns they may have. Customer service is one of our key selling points and after the event, your client will be invited to provide feedback regarding the booking process, communication in the lead up to the event, as well as the event itself.<br />
								...
								<br />
								Further information is available on the <a href="{ADMIN_URL}admin.php?page=tmem-dashboard">{COMPANY_NAME} {APPLICATION_NAME} admin interface</a>.<br />
								<br />
								Regards<br />
								<br />
								{COMPANY_NAME}';
	...
	$email_payment_received_template_args = array(
		...
		$online_quote_template = '[caption id="" align="alignleft" width="128"]{COMPANY_NAME}[/caption]
