			...
			if ( false === $license->success ) {
				...
				switch ( $license->error ) {
					...
					case 'no_activations_left':
						$class      = 'error';
						$messages[] = sprintf( esc_html__( 'Your license key has reached its activation limit. <a href="%s">View possible upgrades</a> now.', 'mobile-events-manager' ), 'https://mem.co.uk/your-account/' );
					...
					default:
						...
						$messages[] = sprintf( esc_html__( 'There was an error with this license key: %1$s. Please <a href="%2$s">contact our support team</a>.', 'mobile-events-manager' ), $error, 'https://mem.co.uk/support' );
					...
					default:
						...
						if ( 'lifetime' === $license->expires ) {
							...
							$messages[] = sprintf(
								...
								date_i18n( get_option( 'date_format' ), strtotime( $license->expires, current_time( 'timestamp' ) ) ),
								'https://mem.co.uk/checkout/?edd_license_key=' . $value
							);
