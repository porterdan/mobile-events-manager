...
*/
	...
	*/
	...
	$email_dj_booking_confirm = '<h1>Booking Confirmation</h1>
								...
								<br />
								Make sure you login regularly to the <a href="{ADMIN_URL}admin.php?page=mem-dashboard">{COMPANY_NAME} {APPLICATION_NAME} admin interface</a> to ensure you have all relevant information relating to their booking.<br />
								<br />
								...
								<br />
								Further information is available on the <a href="{ADMIN_URL}admin.php?page=mem-dashboard">{COMPANY_NAME} {APPLICATION_NAME} admin interface</a>.<br />
								<br />
								Regards<br />
								<br />
								{COMPANY_NAME}';
	...
	$email_payment_received_template = '<h4><span style="color: #ff9900;">Thank you for your {PAYMENT_FOR} payment</span></h4>
								...
								'<a title="Reset your password for the {COMPANY_NAME} {APPLICATION_NAME}" href="http://www.mobileeventsmanager.co.uk//wp-login.php?action=lostpassword">' .
