...
class TMEM_Export {
	...
	public function __construct() {
		$this->event_label_single = esc_html( tmem_get_label_singular() );
		$this->event_label_plural = esc_html( tmem_get_label_plural() );
	} // __construct
	...
	public function can_export() {
		return (bool) apply_filters( 'tmem_export_capability', tmem_employee_can( 'run_reports' ) );
	} // can_export
	...
	public function headers() {
		...
		header( 'Content-Disposition: attachment; filename=tmem-export-' . $this->export_type . '-' . gmdate( 'd-m-Y' ) . '.csv' );
		header( 'Expires: 0' );
	} // headers
	...
	public function get_csv_cols() {
		$cols = $this->csv_cols();
		return apply_filters( 'tmem_export_csv_cols_' . $this->export_type, $cols );
	} // get_csv_cols
	 ...
	 * @access public
	 * @since 1.4
	 * @uses TMEM_Export::can_export()
	 * @uses TMEM_Export::headers()
	 * @uses TMEM_Export::csv_cols_out()
	 * @uses TMEM_Export::csv_rows_out()
	 * @return void
	 */
