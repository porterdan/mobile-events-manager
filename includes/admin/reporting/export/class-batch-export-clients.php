 ...
 * @since 1.4
 */
class MEM_Batch_Export_Clients extends MEM_Batch_Export {
	...
	public function get_data() {
		...
		// Export all clients
		add_filter( 'mem_get_clients_args', array( $this, 'filter_args' ) );
		$clients = mem_get_clients();
		remove_filter( 'mem_get_clients_args', array( $this, 'filter_args' ) );
