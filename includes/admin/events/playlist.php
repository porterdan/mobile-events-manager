 ...
 */
function tmem_playlist_guest_term_remove_delete_row_action( $actions, $tag ) {
...
} // tmem_playlist_guest_term_remove_delete_row_action
add_filter( 'playlist-category_row_actions', 'tmem_playlist_guest_term_remove_delete_row_action', 10, 2 );
 ...
 * @return void
 */
function tmem_playlist_guest_term_remove_checkbox() {
...
add_action( 'admin_footer-edit-tags.php', 'tmem_playlist_guest_term_remove_checkbox' );
 ...
 * @return str
 */
function tmem_playlist_set_guest_term_readonly( $tag ) {
...
} // tmem_playlist_set_guest_term_readonly
add_action( 'playlist-category_edit_form_fields', 'tmem_playlist_set_guest_term_readonly' );
