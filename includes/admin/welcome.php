...
class MEM_Welcome {
	...
	public function admin_menus() {
		// About Page
		add_dashboard_page(
			__( 'Welcome to Mobile Events Manager (MEM)', 'mobile-events-manager' ),
			__( 'Welcome to Mobile Events Manager (MEM)', 'mobile-events-manager' ),
		...
		// Changelog Page
		add_dashboard_page(
			__( 'EMobile Events Manager (MEM) Changelog', 'mobile-events-manager' ),
			__( 'Mobile Events Manager (MEM) Changelog', 'mobile-events-manager' ),
			$this->minimum_capability,
			'mem-changelog',
		...
		add_dashboard_page(
			__( 'Getting started with Mobile Events Manager (MEM)', 'mobile-events-manager' ),
			__( 'Getting started with Mobile Events Manager (MEM)', 'mobile-events-manager' ),
			$this->minimum_capability,
			'mem-getting-started',
		...
		remove_submenu_page( 'index.php', 'mem-about' );
		remove_submenu_page( 'index.php', 'mem-changelog' );
		remove_submenu_page( 'index.php', 'mem-getting-started' );
...
/*<![CDATA[*/
.mem-about-wrap .mem-badge {
	float: right;
	border-radius: 4px;
	margin: 0 0 15px 15px;
	max-width: 200px;
}
.mem-about-wrap #mem-header {
	margin-bottom: 15px;
}
.mem-about-wrap #mem-header h1 {
	margin-bottom: 15px !important;
}
.mem-about-wrap .about-text {
	margin: 0 0 15px;
	max-width: 670px;
}
.mem-about-wrap .feature-section {
	margin-top: 20px;
}
.mem-about-wrap .feature-section-content, .mem-about-wrap .feature-section-media {
	width: 50%;
	box-sizing: border-box;
}
.mem-about-wrap .feature-section-content {
	float: left;
	padding-right: 50px;
}
.mem-about-wrap .feature-section-content h4 {
	margin: 0 0 1em;
}
.mem-about-wrap .feature-section-media {
	float: right;
	text-align: right;
	margin-bottom: 20px;
}
.mem-about-wrap .feature-section-media img {
	border: 1px solid #ddd;
}
.mem-about-wrap .feature-section:not(.under-the-hood) .col {
	margin-top: 0;
}
...
.mem-about-wrap .feature-section-media img {
	...
	public function welcome_message() {
		list( $display_version ) = explode( '-', MEM_VERSION_NUM );
		?>
<div id="mem-header"> <img class="mem-badge" src="<?php echo MEM_PLUGIN_URL . '/assets/images/mem_web_header.png'; ?>" alt="<?php esc_html_e( 'Mobile Events Manager (MEM)', 'mobile-events-manager' ); ?>" / >
  <h1>
		<?php esc_html_e( __( 'Welcome to Mobile Events Manager (MEM) %s', 'mobile-events-manager' ), esc_html( $display_version ) ); ?>
  </h1>
  <p class="about-text">
	...
	<br />
		<?php
		esc_html_e(
			__( 'Mobile Events Manager (MEM) %1$s is ready to make your %2$s business even more efficient!', 'mobile-events-manager' ),
			esc_html( $display_version ),
			esc_html( mem_get_label_plural( true ) )
		);
		?>
  </p>
</div>
	...
	public function tabs() {
		$selected = isset( $_GET['page'] ) ? sanitize_text_field( wp_unslash( $_GET['page'] ) ) : 'mem-about';
		?>
<h1 class="nav-tab-wrapper"> <a class="nav-tab <?php echo 'mem-about' === $selected ? 'nav-tab-active' : ''; ?>" href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'mem-about' ), 'index.php' ) ) ); ?>">
		<?php esc_html_e( "What's New", 'mobile-events-manager' ); ?>
  </a> <a class="nav-tab <?php echo 'mem-getting-started' === $selected ? 'nav-tab-active' : ''; ?>" href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'mem-getting-started' ), 'index.php' ) ) ); ?>">
	...
	public function about_screen() {
		?>
<div class="wrap about-wrap mem-about-wrap">
		<?php
  ...
  <div class="changelog">
	...
	<div class="feature-section">
	  <div class="feature-section-media"> <img src="<?php echo MEM_PLUGIN_URL . '/assets/images/screenshots/14-package-list.png'; ?>"/> </div>
	  <div class="feature-section-content">
		<p>
		  <?php esc_html_e( 'With Mobile Events Manager (MEM) version 1.4, you now have the ability to showcase your business and products.', 'mobile-events-manager' ); ?>
		</p>
		<p>
  ...
  <div class="changelog">
	...
	<div class="feature-section">
	  <div class="feature-section-media"> <img src="<?php echo MEM_PLUGIN_URL . '/assets/images/screenshots/14-reports.png'; ?>"/> </div>
	  <div class="feature-section-content">
		<p>
			  <?php esc_html_e( "Knowing how your business is performing is key to its long term success. With Mobile Events Manager (MEM) version 1.4 we've provided easy access to a number of reports so you have this information at your fingertips at all times.", 'mobile-events-manager' ); ?>
		</p>
		<p><?php printf( esc_html__( 'Reports include income and expenditure, most popular %s types, most successful enquiry sources and more.', 'mobile-events-manager' ), esc_html( mem_get_label_singular( true ) ) ); ?></p>
		<p>
			  <?php
				printf(
  ...
  <div class="changelog">
	...
	<div class="feature-section">
	  <div class="feature-section-media"> <img src="<?php echo MEM_PLUGIN_URL . '/assets/images/screenshots/14-travel-costs.png'; ?>"/> </div>
	  <div class="feature-section-content">
		<p>
			  <?php
				printf(
  ...
  <div class="changelog">
	...
	<div class="feature-section">
	  <div class="feature-section-media"> <img src="<?php echo MEM_PLUGIN_URL . '/assets/images/screenshots/14-rest-api.png'; ?>"/> </div>
	  <div class="feature-section-content">
		<p>
			  <?php esc_html_e( 'Mobile Events Manager (MEM) version 1.4 extends the WordPress REST API enabling easy, yet secure, access to a multitude of data via third party tools and integrations.', 'mobile-events-manager' ); ?>
		</p>
		<p>
			  <?php
				printf(
					...
					'http://mem.co.uk/docs/api/mem-rest-api-introduction/'
				);
				?>
		</p>
	  </div>
  ...
  <div class="return-to-dashboard"> <a href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'mem-settings' ), 'admin.php' ) ) ); ?>">
		<?php esc_html_e( 'Go to Mobile Events Manager (MEM) Settings', 'mobile-events-manager' ); ?>
	</a> &middot; <a href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'mem-changelog' ), 'index.php' ) ) ); ?>">
...
<div class="wrap about-wrap mem-about-wrap">
  ...
  <p class="about-description">
		<?php esc_html_e( "Now that Mobile Events Manager (MEM) is installed, you're ready to get started. It works out of the box, but there are some customisations you can configure to match your business needs.", 'mobile-events-manager' ); ?>
  </p>
  <div class="changelog">
	<h3>
		<?php
	...
	<div class="feature-section">
	  <div class="feature-section-media"> <img src="<?php echo MEM_PLUGIN_URL . '/assets/images/screenshots/mem-first-event.png'; ?>" class="mem-welcome-screenshots"/> </div>
	  <div class="feature-section-content">
		<h4><a href="<?php echo admin_url( 'post-new.php?post_type=mem-event' ); ?>">
		  <?php
			printf(
				esc_html__( 'MEM %1$s &rarr; Create %2$s', 'mobile-events-manager' ),
				esc_html( mem_get_label_plural() ),
				esc_html( mem_get_label_singular() )
			);
			?>
		...
		<p>
			  <?php
				printf(
					esc_html__( 'The MEM %1$s menu is your access point to all aspects of your %2$s creation and setup. To create your first %2$s, simply click Add New and then fill out the %2$s details.', 'mobile-events-manager' ),
					esc_html( mem_get_label_plural() ),
					esc_html( mem_get_label_singular( true ) )
				);
				?>
		...
		<p>
			  <?php
				printf(
					esc_html__( 'If the %1$s type does not exist for the %1$s you are creating, click the <em>Add New</em> link next to the %2$s Type dropdown, enter the %2$s Type name in the text box that is revealed and click <em>Add</em>.<br />To manage all %2$s Types, go to <a href="%4$s">MEM %3$s &rarr; %2$s Types</a>.', 'mobile-events-manager' ),
					esc_html( mem_get_label_singular( true ) ),
					esc_html( mem_get_label_singular() ),
					esc_html( mem_get_label_plural() ),
  ...
  <div class="changelog">
	...
	<div class="feature-section">
	  <div class="feature-section-media"> <img src="<?php echo MEM_PLUGIN_URL . '/assets/images/screenshots/mem-edit-template.png'; ?>"/> </div>
	  <div class="feature-section-content">
		<h4>
		...
		<p>
			  <?php
				printf(
					...
					esc_html( mem_get_label_singular( true ) ),
					'http://mem.co.uk/docs/content-tags/'
				);
				?>
		</p>
		<p>
		...
		<p>
			<?php
				printf(
					...
					esc_html( mem_get_label_singular() ),
					esc_html( mem_get_application_name() )
				);
			?>
		</p>
	</div>
...
<div class="changelog">
	...
	<div class="feature-section">
	<div class="feature-section-media"> <img src="<?php echo MEM_PLUGIN_URL . '/assets/images/screenshots/14-package-options.png'; ?>"/> </div>
	<div class="feature-section-content">
		<h4>
		<?php
			printf(
		...
		<p>
			<?php
				printf(
					...
					esc_html__( 'Once you have enabled %1$s Packages &amp; Add-ons within the <a href="%3$s">MEM %2$s Settings page</a>, manage them within <a href="%4$s">MEM %2$s &rarr; Equipment Packages</a> and a href="%5$s">MEM %2$s &rarr; Equipment Add-ons</a>.', 'mobile-events-manager' ),
					esc_html( mem_get_label_singular( true ) ),
					esc_html( mem_get_label_plural() ),
					admin_url( 'admin.php?page=mem-settings&tab=events' ),
					admin_url( 'edit.php?post_type=mem-package' ),
					admin_url( 'edit.php?post_type=mem-addon' )
				);
			?>
		</p>
	</div>
	...
	<div class="col">
		...
		<p>
			<?php
				printf(
					/* translators: %s: Event Type */
					esc_html__( 'Log all payments your business receives and all expenses you have with the Mobile Events Manager (MEM) Transactions system. Instantly know how profitable your %s are as well as how much money your company has made over differing periods of time.', 'mobile-events-manager' ),
					esc_html( mem_get_label_plural() )
				);
			?>
		</p>
	...
	<div class="col">
		...
		<p>
			<?php
				printf(
					/* translators: %s: Event */
					esc_html__( 'Mobile Events Manager (MEM) supports as many employees as you need at no additional cost. Easily create new employees, set permissions for them to ensure they only have access to what they need, and then assign as many employees to an %s as you need.', 'mobile-events-manager' ),
					esc_html( mem_get_label_singular( true ) )
				);
			?>
		</p>
...
<div class="changelog">
	...
	<div class="col">
		...
		<p>
			<?php esc_html_e( 'Our <a href="https://www.facebook.com/groups/mobile-events-manager/" target="_blank">MEM Facebook User Group</a> is a great way to exchange knowledge with other users and gain tips for use.', 'mobile-events-manager' ); ?>
		</p>
	</div>
	</div>
</div>
<div class="changelog">
	...
	<div class="col">
		...
		<p>
			<?php esc_html_e( 'New add-ons make Mobile Events Manager (MEM) even more powerful. Subscribe to the newsletter to stay up to date with our latest releases. <a href="http://eepurl.com/bTRkZj" target="_blank">Sign up now</a> to ensure you do not miss a release!', 'mobile-events-manager' ); ?>
		</p>
	</div>
	<div class="col">
		<h4>
		...
		<p>
			<?php esc_html_e( '<a href="http://eepurl.com/bTRkZj" target="_blank">Sign up now</a> to hear about the latest tutorial releases that explain how to take Mobile Events Manager (MEM) further.', 'mobile-events-manager' ); ?>
		</p>
	</div>
	</div>
</div>
<div class="changelog">
	...
	<div class="col">
		...
		<p>
			<?php esc_html_e( 'Add-on plugins are available that greatly extend the default functionality of Mobile Events Manager (MEM). There are extensions to further automate Mobile Events Manager (MEM), payment processing and calendar syncronisation.', 'mobile-events-manager' ); ?>
		</p>
	</div>
	<div class="col">
		<h4>
	...
	/**
	 * Parse the MEM readme.txt file
	 *
	 * @since 2.0.3
	 * @return string $readme HTML formatted readme file
	 */
	public function parse_readme() {
		$file = file_exists( MEM_PLUGIN_DIR . '/readme.txt' ) ? MEM_PLUGIN_DIR . '/readme.txt' : null;
	...
	/**
	 * Sends user to the Welcome page on first activation of MEM as well as each
	 * time MEM is upgraded to a new version
	 *
	 * @access public
	 * @since 1.3
	 * @return void
	...
	public function welcome() {
		...
		if ( ! get_transient( '_mem_activation_redirect' ) ) {
			return;
		}

		// Delete the redirect transient.
		delete_transient( '_mem_activation_redirect' );
		...
		$upgrade = get_option( 'mem_version_upgraded_from' );

		if ( ! $upgrade ) { // First time install.
			wp_safe_redirect( admin_url( 'index.php?page=mem-getting-started' ) );
			exit;
		} else { // Update.
			wp_safe_redirect( admin_url( 'index.php?page=mem-about' ) );
			exit;
		}
	} // welcome
}
