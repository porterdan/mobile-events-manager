 ...
 */
function mem_email_template_post_columns( $columns ) {
	...
	return $columns;
} // mem_email_template_post_columns
add_filter( 'manage_email_template_posts_columns', 'mem_email_template_post_columns' );
 ...
 */
function mem_email_template_post_row_actions( $actions, $post ) {
...
} // mem_email_template_post_row_actions
add_filter( 'post_row_actions', 'mem_email_template_post_row_actions', 10, 2 );
 ...
 */
function mem_email_template_title_placeholder( $title ) {
	global $post;
...
} // mem_email_template_title_placeholder
add_filter( 'enter_title_here', 'mem_email_template_title_placeholder' );
 ...
 */
function mem_email_template_rename_publish_button( $translation, $text ) {

	global $post;

	if ( ! isset( $post ) || 'mem-quotes' != $post->post_type ) {
		return $translation;
	}
...
add_filter( 'gettext', 'mem_email_template_rename_publish_button', 10, 2 );
 ...
 */
function mem_email_template_post_messages( $messages ) {
	...
	return apply_filters( 'mem_email_template_post_messages', $messages );

} // mem_email_template_post_messages
add_filter( 'post_updated_messages', 'mem_email_template_post_messages' );
