 ...
 * @return void
 */
function tmem_add_employee_action( $data ) {

	if ( ! wp_verify_nonce( $data['tmem_nonce'], 'add_employee' ) ) {
...
} // tmem_add_employee_action
add_action( 'tmem-add_employee', 'tmem_add_employee_action' );
