...
/**
 * MEM_DB_Availability Class
 *
 * @since 1.5.5
 */
class MEM_DB_Availability extends MEM_DB {
	...
	public function __construct() {
		...
		$this->table_name  = $wpdb->prefix . 'mem_availability';
		$this->primary_key = 'id';
		$this->version     = '1.0';
	...
	public function get_required_fields() {
		return apply_filters(
			'mem_db_availability_required_fields',
			array(
				'employee_id',
				'start',
				'end',
	...
	public function add( $data = array() ) {
		...
		if ( $return ) {
			foreach ( $meta as $key => $value ) {
				MEM()->availability_meta->update_meta( $return, $key, $value );
			}
		}
	...
	public function get_entries( $args = array() ) {
		...
		$cache_key = md5( 'mem_availability_' . serialize( $args ) );
