 ...
 * If you wish to make changes, copy this file to your theme directory /theme/mem-templates/event/event-none.php
...
<div id="client-no-events">
	...
	<p><?php printf( esc_html__( 'You do not currently have any active %s booked with us.', 'mobile-events-manager' ), esc_html( mem_get_label_plural() ) ); ?></p>
