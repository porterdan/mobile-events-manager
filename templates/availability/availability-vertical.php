<?php
/**
 * This template is used to display the availability form with shortcode [tmem-availability display="vertical"].
 *
 * @version 1.0
 * @author Mike Howard
 * @since 1.3
 ...
 * If you wish to make changes, copy this file to your theme directory /theme/tmem-templates/availabilty/availabilty-vertical.php
...
<div id="tmem-availability-checker">
	...
	<input type="text" name="{field}" id="{field}" class="{field_class}" size="20" placeholder="<?php echo esc_html( tmem_format_datepicker_date() ); ?>" /></p>
	<p><input type="submit" name="tmem-submit-availability" id="tmem-submit-availability" class="{submit_class}" value="{submit_text}" /></p>
